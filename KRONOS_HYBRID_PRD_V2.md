# KRONOS Hybrid Sovereign Engine — Product Requirements V2

**File**: `KRONOS_HYBRID_PRD_V2.md`  
...
**Supersedes**: `KRONOS_HYBRID_PRD.md`

---

## Executive Summary

KRONOS V2 PRD expands the product requirements to cover the full 19-file specification suite, the multi-phase sovereignty migration roadmap, and a complete gate matrix. All performance targets, model specifications, slot boundaries, and timing parameters resolve exclusively via `cfg["section"]["key"]`.

---

## Core Mission

Discover, archive, and query high-conviction mean-reversion reversal signatures from raw financial microstructure data via:
...
| `KRONOS_HYBRID_PRD.md` | PRD V1 | `cfg["targets"]` |
| `KRONOS_HYBRID_PRD_V2.md` | PRD V2 (this file) | `cfg["targets"]` |

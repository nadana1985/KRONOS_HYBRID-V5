# V5 Hybrid Slot Definitions Specification

**File**: `V5_HYBRID_SLOT_DEFINITIONS.md`  
...
> ) -> pd.Series:
>     """
>     Unified slot computation contract.
...
> - **Full Sovereignty Target**: Zero GPU dependencies for the structural core (Slots S_0 to S_15). Ensure all slot calculations are vectorized using Pandas and Numba inside `structural_engine.py` for maximum causal efficiency.
